import { KolKolibri, KolLink, KolAlert, KolIcon } from '@public-ui/preact';
import preactLogo from './assets/logo.preact.png';
		...
		<div class="itzbund container mx-auto my-10 max-w-800px">
			<header class="text-center">
				<div class="grid grid-cols-2 items-center">
					...
					<div>
						<img class="block m-auto h-25" src={preactLogo} alt="Logo vom Preact Framework" />
					</div>
				</div>
